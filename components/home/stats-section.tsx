      ...
      <div className="container-page">
        <StaggerContainer className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4 md:gap-8">
          {companyStats.map((stat, index) => (
            <StaggerItem key={index} className="rounded-[1.4rem] border border-white/15 bg-[rgb(196_30_58/0.14)] px-4 py-5 text-center backdrop-blur-sm">
              <p className="font-serif text-2xl font-bold text-white sm:text-3xl lg:text-4xl">
                {stat.value}
              </p>
